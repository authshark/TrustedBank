 ...
 * in fails.
 */
public abstract class AddSMSTmpPanel extends Panel
{
	/** Field for token ID. */
	private RequiredTextField smsTmpId;

	/**
	 * Sign in form.
	 */
	public final class addTmpSMSForm extends Form
	{
		 ...
		 */
		public addTmpSMSForm(final String id)
		{
			super(id);
			
			// Attach textfield components that edit properties map in lieu of a formal beans model
			add(smsTmpId = new RequiredTextField("tmpSMSIdInput", new PropertyModel(properties, "tmpSMSIdInput")));
		}
	 ...
	 */
	public AddSMSTmpPanel(final String id)
	{
		super(id);

		// Create feedback panel and add to page
		final FeedbackPanel feedback = new FeedbackPanel("addTmpSMSFeedback");
		add(feedback);

		// Add sign-in form to page, passing feedback panel as
		// validation error handler
		Form signUpForm = new addTmpSMSForm("addTmpSMSForm");
		add(signUpForm);
	}
	 ...
	 * @return The token ID
	 */
	public String getSMSTmpId()
	{
		return smsTmpId.getModelObjectAsString();
	}
	
	public abstract boolean addSMSTmpId(String tmpSMSId);
}
