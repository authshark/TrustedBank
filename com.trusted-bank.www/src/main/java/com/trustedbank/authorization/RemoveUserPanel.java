 ...
 * in fails.
 */
public abstract class RemoveUserPanel extends Panel
{
	 ...
	 * Sign in form.
	 */
	public final class removeUserForm extends Form
	{
		 ...
		 */
		public removeUserForm(final String id, List users)
		{
			super(id);
			add(new DropDownChoice("userList",new PropertyModel(myChoice,"choice"),users));
		}
		...
		public final void onSubmit()
		{
			if (myChoice.getChoice()!= null) {
				if(removeUserId(myChoice.getChoice())){
					info ("User removed!!");
				}
	 ...
	 */
	public RemoveUserPanel(final String id, List users)
	{
		super(id);

		// Create feedback panel and add to page
		final FeedbackPanel feedback = new FeedbackPanel("removeUserFeedback");
		add(feedback);

		// Add sign-in form to page, passing feedback panel as
		// validation error handler
		Form signUpForm = new removeUserForm("removeUserForm", users);
		add(signUpForm);
	}
	
	public abstract boolean removeUserId(String user);
}
